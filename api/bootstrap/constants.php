...
define('DB_ONE_SIGNAL_TABLE', 'one_signal');
...
define('HANGOUTS_ACCOUNT', 'hangouts_account');
...
define('PARENT_PROFILE', 'parent_profile');
...
define('SEX', 'sex');
define('SKYPE_ACCOUNT', 'skype_account');
define('STATE', 'state');
define('STAR_SIGN', '*');
...
define('SUCCESSFULLY_SUBSCRIBED', 'Başarıyla abone olundu');
...
define('TIME', 'time');
define('TOP_CITIES', 'top_cities');
define('TOP_LECTURES', 'top_lectures');
define('TOTAL', 'total');
...
define('ONE_SIGNAL_DEVICE_ID', 'one_signal_device_id');
define('ORDER', 'order');
...
define('VALUE', 'value');
define('ZOOM_ACCOUNT', 'zoom_account');
