...
<div align="center" style="background: #722947; width: auto; margin: 0 5%; padding: 8px; border-radius: 8px 8px 0 0;">
    <img src="https://images.ozelden.com/resources/logo-gold.png" style="height: 32px; margin-top: 8px;">
    <p style="font-size: 14px; margin: 0;">özel ders almanın en akıllı yolu</p>
</div>
...
-moz-box-shadow: 0 4px 16px 4px #909090 ; box-shadow: 0 4px 16px 4px #909090;" align="center">
    <h3 style="color: #722947;">Şifre değişikliği</h3>
    <p>Giriş için aşağıdaki bilgileri kullanabilirsin: </p>
    <p><b>Email:</b> {{$email}}</p>
    <p><b>Yeni Şifre:</b> {{$password}}</p>
...
<div align="center" style="background: #722947; width: auto; margin: 0 5%; padding: 8px; border-radius: 0 0 8px 8px;">
    ...
    <a style="color: #fff; text-decoration: none; margin: 4px;" target="_blank" href="https://www.instagram.com/ozeldencom/"><img src="https://images.ozelden.com/resources/instagram.svg"/></a>
    <a style="color: #fff; text-decoration: none; margin: 4px;" target="_blank" href="https://www.facebook.com/ozelden/"><img src="https://images.ozelden.com/resources/facebook.svg"/></a>
    <a style="color: #fff; text-decoration: none; margin: 4px;" target="_blank" href="https://twitter.com/ozelden4"><img src="https://images.ozelden.com/resources/twitter.svg"/></a>
</div>
</body>
</html>
